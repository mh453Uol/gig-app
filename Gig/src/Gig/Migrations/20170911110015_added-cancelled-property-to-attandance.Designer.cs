...
namespace Gig.Migrations
{
    ...
    [Migration("20170911110015_added-cancelled-property-to-attandance")]
    partial class addedcancelledpropertytoattandance
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Gig.Models.UserNotification", b =>
                {
            ...
            modelBuilder.Entity("Gig.Models.Gig", b =>
                {
                    b.HasOne("Gig.Models.ApplicationUser", "Artist")
                        .WithMany()
                        .HasForeignKey("ArtistId");

                    b.HasOne("Gig.Models.Genre", "Genre")
                        .WithMany()
            ...
            modelBuilder.Entity("Gig.Models.UserNotification", b =>
                {
                    b.HasOne("Gig.Models.Notification", "Notification")
                        .WithMany()
                        .HasForeignKey("NotificationId");

                    b.HasOne("Gig.Models.ApplicationUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Gig.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
